...
<form action="regiAf.do" name="frmForm" id="_frmForm" method="POST"> 
			...
			<div class="">
				<label for="id">아이디</label><br>
					<input type="text" class="" id="_id" name="id" placeholder="ID" required>
				<div id="id_check"></div>
			</div>
			<!-- 비밀번호 -->
			<div class="">
				<label for="pwd">비밀번호</label><br>
					<input type="password" class="" id="_pwd" name="pwd" placeholder="PASSWORD" required>
				<div class="" id="pwd_check"></div>
			</div>
			<!-- 비밀번호 재확인 -->
			<div class="">
				<label for="pwd2">비밀번호 확인</label><br>
					<input type="password" class="" id="_pwd2" name="pwd2" placeholder="Confirm Password" required>
