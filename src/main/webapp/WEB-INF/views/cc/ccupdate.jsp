...
<tr>
	<th>클래스명</th>
	<td style="text-align: left">
		<input type="text" name="title" size="50" value="${cc.title}">
	</td>
</tr>
<tr>
	<th>위치</th>
	<td class="input-group">
		...
		<input type="button" onclick="sample2_execDaumPostcode()" value="주소검색" required="required"><br>
...
<tr>
	<th>모집인원</th>
	<td style="text-align: left">
		<input type="text" id="membernum" name="membernum" value="${cc.membernum}">
...
<tr>
	<th>클래스요일</th>
	<td>
		월<input type="checkbox" name="day" id="mon" value="월"> 
		화<input type="checkbox" name="day" id="tus" value="화">
		수<input type="checkbox" name="day" id="wed" value="수" > 
		목<input type="checkbox" name="day" id="thu" value="목">
		금<input type="checkbox" name="day" id="fri"	value="금"> 
		토<input type="checkbox" name="day" id="sat" value="토">
		일<input type="checkbox" name="day" id="sun" value="일">
	</td>
</tr> 
<tr hidden="hidden"> 
	<th>클래스요일</th>
...
<tr>
	<td colspan="2" style="height:50px; text-align:center;">
		<span>
			<button type="button" id="btnupdate" title="수정하기">수정</button>
...
function writeCal() {
	...
	var allData = {"seq_class": seq_class, "title": title, "cdate1": cdate1, "cdate2": cdate2, "cday": cday};
